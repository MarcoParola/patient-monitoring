...
class PoseClassifier(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        if len(self.val_outputs) > 0:  # Assicurarsi che ci siano output per calcolare la confusion matrix
            ...
            self.logger.experiment.log({"Validation Confusion Matrix": plt.gcf()})
            plt.close()
    ...
    def on_test_epoch_end(self):
        ...
        self.logger.experiment.log({"Test Confusion Matrix": plt.gcf()})
        plt.close()
