...
class OpenPoseAPI:
    def __init__(self, video_path=None, detect_face=False, detect_hands=False, fps=1):
        ...
        keypoints_per_frame = 25  # Corpo base (Body-25)
        if detect_hands:
            keypoints_per_frame += 21 * 2  # Mani (21 keypoints per mano)
        if detect_face:
            keypoints_per_frame += 70  # Viso
        
        # Calcola il numero totale di feature
        self.feature_dim = keypoints_per_frame * fps * video_duration
