...
def load_model(cfg):
    ...
    if cfg.task == "classification":
        ...
        model = PoseClassifier(input_shape=(cfg.train.batch_size, cfg.in_channels, cfg.depth, cfg.width, cfg.height), output_dim=cfg.output_dim, backbone=cfg.conv_backbone, detect_face=cfg.openpose.detect_face, detect_hands=cfg.openpose.detect_hands, fps=cfg.pose_dataset.fps)
